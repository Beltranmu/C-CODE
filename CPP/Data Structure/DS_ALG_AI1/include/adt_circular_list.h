...
typedef struct adt_circular_list_s {
	...
	u16 length_;
	u16 capacity_;
	struct circular_list_ops_s *ops_;
} Cricular_List;
...
struct circular_list_ops_s {
   ...
   */
	s16 (*destroy)(Cricular_List *list);
   ...
   * @return - kErrorCode_List_Null when the list to be soft-reset is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16 (*softReset)(Cricular_List *list);
   ...
   * @return - kErrorCode_List_Null if the list to be resized is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
	s16 (*resize)(Cricular_List *list, u16 new_size);
   ...
   */
	u16 (*capacity)(Cricular_List *list);
   ...
   */
	bool (*isEmpty)(Cricular_List *list);
   ...
   */
	bool (*isFull)(Cricular_List *list);
   ...
   */
  void* (*at)(Cricular_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16 (*insertFirst)(Cricular_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16 (*insertLast)(Cricular_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16 (*insertAt)(Cricular_List *list, void *data, u16 bytes, u16 position);
   ...
   */
	void* (*extractFirst)(Cricular_List *list);
   ...
   */
	void* (*extractLast)(Cricular_List *list);
   ...
   */
	void* (*extractAt)(Cricular_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if one of the two list param are NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
	s16 (*concat)(Cricular_List *list, Cricular_List *list_src);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
	s16 (*traverse)(Cricular_List *list, void (*callback)(MemoryNode *));
   ...
   */
	...
	void (*print)(Cricular_List *list); // Prints the features and content of the list
};

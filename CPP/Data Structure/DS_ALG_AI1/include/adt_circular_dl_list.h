// adt_circular_dl_list.h
// Escuela Superior de Arte y Tecnologia
// Algoritmos & Inteligencia Artificial
// ESAT 2020-2021
//

#ifndef __ADT_CIRCULAR_DL_LIST_H__
#define __ADT_CIRCULAR_DL_LIST_H__

#include "adt_memory_node.h"

/**
 * @struct ADT Circular Doubly-LinkedList 
 ...
 * @var *ops_ pointer to CircularDL_List Functions.
 */
typedef struct adt_circular_dl_list_s {
	MemoryNode* head_;
	MemoryNode* tail_;
	u16 length_;
	u16 capacity_;
	struct circular_dl_list_ops_s *ops_;
} Circular_DL_List;

/**
 * @struct Circular Doubly-LinkedList_Ops_s.
 * @brief Contains all the *ops functions.List
 */
struct circular_dl_list_ops_s {
   ...
   */
  s16(*destroy)(Circular_DL_List *list);
   ...
   * @return - kErrorCode_List_Null when the list to be soft-reset is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*softReset)(Circular_DL_List *list);
   ...
   * @return - kErrorCode_List_Null when the list to be reset is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*reset)(Circular_DL_List *list);
   ...
   * @return - kErrorCode_List_Null if the list to be resized is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*resize)(Circular_DL_List *list, u16 new_size);
   ...
   */
  u16(*capacity)(Circular_DL_List *list);
   ...
   */
  u16(*length)(Circular_DL_List *list);
   ...
   */
  bool(*isEmpty)(Circular_DL_List *list);
   ...
   */
  bool(*isFull)(Circular_DL_List *list);
   ...
   */
  void* (*first)(Circular_DL_List *list);
   ...
   */
  void* (*last)(Circular_DL_List *list);
   ...
   */
  void* (*at)(Circular_DL_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertFirst)(Circular_DL_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertLast)(Circular_DL_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertAt)(Circular_DL_List *list, void *data, u16 bytes, u16 position);
   ...
   */
  void* (*extractFirst)(Circular_DL_List *list);
   ...
   */
  void* (*extractLast)(Circular_DL_List *list);
   ...
   */
  void* (*extractAt)(Circular_DL_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if one of the two list param are NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*concat)(Circular_DL_List *list, Circular_DL_List *list_src);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*traverse)(Circular_DL_List *list, void(*callback)(MemoryNode *));
  ...
  void(*print)(Circular_DL_List *list); // Prints the features and content of the list
};
...
#endif //__ADT_CIRCULAR_DL_LIST_H__

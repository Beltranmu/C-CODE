...
#ifndef __ADT_DL_LIST_H__
#define __ADT_DL_LIST_H__

#include "adt_memory_node.h"

/**
 * @struct ADT Double-LinkedList 
 ...
 */
typedef struct adt_dl_list_s {
	MemoryNode* head_;
	MemoryNode* tail_;
	u16 length_;
	u16 capacity_;
	struct dl_list_ops_s *ops_;
} DL_List;

/**
 * @struct Double-LinkedList_Ops_s.
 * @brief Contains all the *ops functions.List
 */
struct dl_list_ops_s {
  /**
   ...
   * @return - kErrorCode_List_Null if the list to be resized is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*resize)(DL_List *list, u16 new_size);
   ...
   */
  void* (*at)(DL_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertFirst)(DL_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertLast)(DL_List *list, void *data, u16 bytes);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*insertAt)(DL_List *list, void *data, u16 bytes, u16 position);
   ...
   */
  void* (*extractFirst)(DL_List *list);
   ...
   */
  void* (*extractAt)(DL_List *list, u16 position);
   ...
   * @return - kErrorCode_List_Null if one of the two list param are NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*concat)(DL_List *list, DL_List *list_src);
   ...
   * @return - kErrorCode_List_Null if the list is NULL.
             ...
             - kErrorCode_Ok Everething was done correctly.
   */
  s16(*traverse)(DL_List *list, void(*callback)(MemoryNode *));
  ...
  void(*print)(DL_List *list); // Prints the features and content of the list
};

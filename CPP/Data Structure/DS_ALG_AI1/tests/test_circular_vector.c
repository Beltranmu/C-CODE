// test_circular_vector.c
// Escuela Superior de Arte y Tecnologia
// Algoritmos & Inteligencia Artificial
// ESAT 2020-2021
//
// Test battery for circular vector ADT
...
int main() {
	...
	vector_1 = CIRCULAR_VECTOR_create(kCapacityVector1);
	if (NULL == vector_1) {
		printf("\n create returned a null node in vector_1\n");
		return -1;
	}
	vector_2 = CIRCULAR_VECTOR_create(kCapacityVector2);
	if (NULL == vector_2) {
		printf("\n create returned a null node in vector_2\n");
		return -1;
	}
	vector_3 = CIRCULAR_VECTOR_create(kCapacityVector3);
	if (NULL == vector_3) {
	...
	printf("\n\n---------------- NULL BATTERY ----------------\n\n");
	printf("\n\n# Test Create\n");
	vector_2 = CIRCULAR_VECTOR_create(0);
	if (NULL != vector_2) {

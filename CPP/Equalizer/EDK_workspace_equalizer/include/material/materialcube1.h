...
class  MaterialCube1 : public EDK3::Material {
public:
  ...
  class SettingsMatCube1 : public EDK3::MaterialSettings {
  public:
    SettingsMatCube1()
    {
      /*for (int i = 0; i < 4; ++i) {
  ...
  protected:
    virtual ~SettingsMatCube1() {}
  private:
    SettingsMatCube1(const SettingsMatCube1&);
    SettingsMatCube1& operator=(const SettingsMatCube1&);
   /* float color_data[4];
    float color_data2[4];
...
private:
  ...
  MaterialCube1(const MaterialCube1&);
  MaterialCube1& operator=(const MaterialCube1 &);

...
void Common_Update()
{
    ...
    */
    ...
    while (_kbhit())
    {
        ...
        //CROSSFADING
        else if (key == 'q')    newButtons |= (1 << BTN_ACTIONQ);
        else if (key == 'w')    newButtons |= (1 << BTN_ACTIONW);


        //PIANO
        else if (key == 's')    newButtons |= (1 << BTN_ACTIONS);
        else if (key == 'e')    newButtons |= (1 << BTN_ACTIONE);
        else if (key == 'd')    newButtons |= (1 << BTN_ACTIOND);
        else if (key == 'r')    newButtons |= (1 << BTN_ACTIONR);
        else if (key == 'f')    newButtons |= (1 << BTN_ACTIONF);

        else if (key == 'g')    newButtons |= (1 << BTN_ACTIONG);
        else if (key == 'y')    newButtons |= (1 << BTN_ACTIONY);
        else if (key == 'h')    newButtons |= (1 << BTN_ACTIONH);
        else if (key == 'u')    newButtons |= (1 << BTN_ACTIONU);
        else if (key == 'j')    newButtons |= (1 << BTN_ACTIONJ);
        else if (key == 'i')    newButtons |= (1 << BTN_ACTIONI);
        else if (key == 'k')    newButtons |= (1 << BTN_ACTIONK);
